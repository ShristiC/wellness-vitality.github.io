...
function Logo() {
    return (
        <img src={LogoImage} alt='A tree whose roots are shaped out of a spiral, and the leaves are getting larger in size as they emerge outside the circle. Next to it, the words Wellnes n Vitality.' width={250} />
    );
}
